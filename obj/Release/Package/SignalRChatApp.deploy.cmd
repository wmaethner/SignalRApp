...
set _DeploySetParametersFile=%RootPath%SignalRChatApp.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SignalRChatApp.zip" (
echo "%RootPath%SignalRChatApp.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SignalRChatApp.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SignalRChatApp.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%SignalRChatApp.deploy-readme.txt" (
...
start notepad "%RootPath%SignalRChatApp.deploy-readme.txt"
)
echo =========================================================
goto :eof
